    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-sky-900 flex flex-col items-center justify-center p-4">
      <div className="flex flex-col items-center justify-center flex-1 w-full max-w-md">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-white mb-2">INES DEBROISE</h1>
          <p className="text-blue-200 text-lg">Rhode Island Basket</p>
        </div>

        {/* Boutons */}
        <div className="w-full space-y-6">
          <a
            href="https://www.carlaleitefan.com/livestats/ines"
            target="_blank"
          ...
          <a
            href="https://www.carlaleitefan.com/stats/ines"
            target="_blank"
            rel="noopener noreferrer"
